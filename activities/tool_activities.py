...
class ToolActivities:
    @activity.defn
    async def validate_llm_prompt(self, validation_input: ValidationInput) -> ValidationResult:
        """
        ...
        for tool in validation_input.agent_goal.tools:
            ...
            tool_str += "Arguments: " + ", ".join([f"{arg.name} ({arg.type})" for arg in tool.arguments])
